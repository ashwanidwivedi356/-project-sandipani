...
class Booking(models.Model):
    ...
    anusthan = models.CharField(max_length=200)
    pandit_details = models.TextField()
    booking_date = models.DateField()
    ...
    class Meta:
        unique_together = ('user', 'booking_date')  # Prevent duplicate booking for the same user on the same date
